      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-end mb-12 border-b border-white/10 pb-8">
          <div>
            ...
            <p className="text-slate-400 font-bold uppercase tracking-[0.3em] mt-2">
              Ready for Grandmaster Analysis
            </p>
          </div>
          <div className="flex gap-4">
            ...
            <button
              onClick={onClose}
              className="px-6 py-3 bg-[#1a1f26] hover:bg-[#252b35] text-slate-200 font-black uppercase tracking-widest text-xs rounded-xl border border-white/10 transition-all shadow-xl"
            >
              Back
            </button>
          </div>
        ...
        {games.length === 0 ? (
          <div className="bg-[#11151c] border border-white/10 rounded-[3rem] p-20 text-center shadow-2xl">
            ...
            <p className="text-slate-600 text-sm mt-2 font-medium">
              Import a PGN file or sync from Chess.com above.
            </p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="shrink-0 flex items-center gap-4">
                  <div className="bg-white/5 p-4 rounded-2xl group-hover:bg-indigo-600 transition-all shadow-inner">
                    <p className="text-[8px] font-black uppercase text-slate-500 group-hover:text-indigo-200 mb-1">
                      Analyze
                    </p>
                    <ChevronRight
                      size={24}
