...
const SectionHeader: React.FC<{ label: string }> = ({ label }) => (
  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 mb-3 mt-6 first:mt-0">
    {label}
  </p>
);
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <Toggle
            ...
            onChange={() =>
              setBoardSetting("showCoordinates", !board.showCoordinates)
            }
          />
          <Toggle
            ...
            onChange={() =>
              setBoardSetting("animatePieces", !board.animatePieces)
            }
          />
