...
export const MoveLedger: React.FC<MoveLedgerProps> = ({
  ledger,
  activeMoveIdx,
  onMoveClick,
}) => {
              ...
              return (
                <React.Fragment key={i}>
                  ...
                  >
                    ...
                    <td
                      className={cn(
                        "py-2 px-3 w-[45%] border-l border-white/5",
                        blackActive && "bg-indigo-500/10",
                      )}
                    >
                      {round.black ? (
                        <div className="flex justify-between items-baseline">
                          ...
                          {round.black.eval && (
                            <span className="text-[9px] font-mono text-indigo-500/50">
                              {round.black.eval}
                            </span>
                          )}
                        </div>
                  ...
                  {round.white.comment && whiteActive && (
                    <tr className="bg-indigo-500/5">
                      ...
                      <td
                        colSpan={2}
                        className="py-2 px-4 text-[10px] text-indigo-300/80 leading-relaxed italic font-medium"
                      >
                        {round.white.comment}
                      </td>
                    </tr>
