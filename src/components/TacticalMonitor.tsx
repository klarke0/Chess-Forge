  ...
  return (
    <div
      className={cn(
        ...
        status === "correct"
          ? "border-emerald-500/30 bg-emerald-500/5 shadow-inner shadow-emerald-500/10"
          : status === "novelty"
            ? "border-indigo-500/30 bg-indigo-500/5 shadow-inner shadow-indigo-500/10"
            : status === "wrong"
              ? "border-rose-500/30 bg-rose-500/5 shadow-inner shadow-rose-500/10 animate-shake"
              : "border-white/5",
      )}
    >
      <div className="flex gap-4">
        ...
        <div className="flex-1 py-0.5">
          <h2 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-600 mb-1">
            Tactical Monitor
          </h2>
          <p className="text-lg font-bold leading-tight text-white mb-1.5">
            {message}
          </p>
          {hint && (
