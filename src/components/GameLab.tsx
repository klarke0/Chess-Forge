...
export const GameLab: React.FC<GameLabProps> = ({ initialPgn }) => {
  ...
  const currentFen =
    currentMoveIndex < 0 || !reviewedMoves[currentMoveIndex]
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => {
                reset();
                setCurrentMoveIndex(-1);
                setLabSetting("showEngine", false);
              }}
          ...
          <div className="flex-[1.5] flex flex-col items-center p-4 lg:p-6 gap-4 bg-[#0d1117]/20 min-h-0">
            ...
            <div className="w-full max-w-[min(55vh,420px)] aspect-square shrink-0 relative">
              <div className="w-full h-full shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] rounded-[2rem] overflow-hidden border-[12px] border-[#161b22] bg-[#161b22] relative">
                ...
                />
                {showVision && (
                  <VisionOverlay control={controlMap} orientation="white" />
                )}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    showVision
                      ...
                      : "bg-[#1a1f26] text-slate-400 border-white/10 hover:text-white",
                  )}
                >
                  <Layers size={16} />
                </button>
            ...
            >
              ...
              >
                ...
                {currentMoveIndex >= 0 && (
                  <line
                    x1={
                      ((currentMoveIndex + 0.5) / reviewedMoves.length) * 1000
                    }
                    y1="0"
                    x2={
                      ((currentMoveIndex + 0.5) / reviewedMoves.length) * 1000
              ...
              <button
                ...
                aria-label={
                  evalExpanded ? "Collapse eval chart" : "Expand eval chart"
                }
              >
                {evalExpanded ? (
                  <ChevronDown size={13} />
              ...
              {reviewedMoves.map((move, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        "font-bold text-sm min-w-[52px]",
                        isWhite ? "text-white" : "text-slate-300",
                      )}
                    >
                      {move.san}
                    </span>
        ...
        <div className="flex justify-center gap-8 text-center">
          {[
            ...
            },
            {
              ...
              label: "? Mistake",
              desc: "0.5–3 pawns lost",
            },
            {
              color: "text-emerald-400",
              label: "! Good",
              desc: "Best or near-best",
            },
